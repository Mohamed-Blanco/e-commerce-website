...
<div class="bg-green-100 p-5">
    ...
    <div style="width: 100%;" class="bdy bg-white w-100  md:flex flex-row  p-12 ">
        <div class="bg-white flex-row justify-center md:w-100 md:w-2/5 mr-12">
            <div>
                <img class="rounded-lg border-gray-200 border-2 hover:border-gray-500"
                    src="https://enovathemes.com/propharm/wp-content/uploads/product62.jpg" alt="">
            </div>
            <div class="flex my-5 gap-8">
                <img class="rounded-lg w-24 hover:border-gray-500 border-gray-200 border-2"
                    src="https://enovathemes.com/propharm/wp-content/uploads/product62.jpg" alt="">
                <img class="rounded-lg w-24 hover:border-gray-500 border-gray-200 border-2"
                    src="https://enovathemes.com/propharm/wp-content/uploads/product62.jpg" alt="">
            </div>
