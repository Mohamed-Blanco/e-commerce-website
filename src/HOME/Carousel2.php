    ...
    <div id="default-carousel" class="relative p-5" data-carousel="static">
      <div class="relative overflow-hidden carousel-heights">
        ...
        <div class="hidden md:block">
          <?php foreach ($groupedProductsReversed as $index => $group): ?>
                  ...
                  <?php foreach ($group as $product): ?>
                    <div class="w-56 p-4 mx-4 bg-white border-2 group">
                      ...
                      <div class="relative">
                        ...
                        <?php if ($product['Imagep']): ?>
                          <img src="data:image/png;base64,<?= base64_encode($product['Imagep']) ?>" alt="<?= $product['Libellép'] ?>" class="object-cover w-full h-40">
                        <?php else: ?>
                          <img src="https://via.placeholder.com/200" alt="No image found" class="object-cover w-full h-40">
                        <?php endif; ?>
                      </div>
                      <div class="group">
                        <ul>
