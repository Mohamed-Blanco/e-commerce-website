  ...
  <header>
    ...
    <div class="relative bg-b">
        ...
        <div class="relative px-4 mx-auto sm:px-6 lg:px-8">
            <nav class="flex flex-initial  justify-between items-center  h-16 lg:h-20">
                <div class="flex-shrink-0">
                    <a href="#" title="" class="flex">
                        <img style="height: 180px;" class="w-auto h-8 lg:h-10" src="../images/logo.png" alt="" />
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-10">
                    ...
                    <a href="#" title="" class="text-base font-medium text-white"> Products</a>

                    <a href="#" title="" class="text-base font-medium text-white"> About </a>

                    <a href="#" title="" class="text-base font-medium text-white"> Contact Us </a>
                    

                </div>
                <a href="" class=" text-white"><i  class="fa-solid fa-cart-shopping"></i></a>
                <a href="#" title="" class="items-center justify-center hidden px-6 py-3 text-base font-semibold text-black transition-all duration-200 bg-yellow-400 border border-transparent rounded-full lg:inline-flex hover:bg-yellow-500 focus:bg-yellow-500" role="button">Login</a>
