...
<body style="background-color:white">
    ...
    <section class="py-12">
        <div class="flex justify-between container mx-auto px-4 mt-10">
            <table class="md:ml-5 md:w-3/5 text-left shadow-lg rounded-lg">
                ...
                <tbody class="h-28">
                    <tr class="text-gray-700 text-center">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-1.5">
                                <div class="flex-shrink-0 w-10 h-10">
                                    <img class="w-full h-full rounded-full" src="../images/dolip.jpg"
                                        alt="product image" />
                                </div>
                                <div class="ml-3">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <button
                                class="p-2 rounded-full hover:bg-red-100 border border-transparent hover:border-red-500 text-red-500 hover:text-red-600">
            ...
            <table class=" w-full md:w-1/3 md:mr-5 sm:1/3 text-left shadow-lg rounded-lg">
                <thead class="h-16">
                    <tr class="text-xs text-center text-gray-500 bg-gray-50 uppercase border-b">
                    ...
                    <tr>
                        <th class="px-7">
                            <div class="flex flex-col space-y-4">
                                <a href="/sheckout"
                                    class="bg-amber-600 text-white font-bold py-2 rounded-full text-center hover:bg-amber-700">
                                    Proceed to checkout
                                </a>
                                <a href="../PRODUCTS/productsview.php"
                                    class="bg-gray-200 text-gray-800 font-bold py-2 rounded-full text-center hover:bg-gray-300">
                                    Continue Shopping
                                </a>
                            </div>
                        </th>
